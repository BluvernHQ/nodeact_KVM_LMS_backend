...
func CreateSection(w http.ResponseWriter, r *http.Request, db *mongo.Client, authClient *auth.Client) {
...
collection = db.Database("KVM").Collection("Sections")
	...
	if err == mongo.ErrNoDocuments{
		...
		http.Error(w, "Error creating Sections", http.StatusConflict)
		return
	}
}
